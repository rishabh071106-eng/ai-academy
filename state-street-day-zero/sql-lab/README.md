...
python3 run_sqlite.py          # builds custody_lab.db and prints all 13 query results
...
| File | Purpose |
|---|---|
| `schema.sql` | 10 tables: 5 dimensions (client, account, security, date, fund) and 5 facts (positions, transactions, trades, corporate actions, NAV). Grain documented at the top. |
...
| `queries.sql` | Q1–Q13, each labelled with the portal screen it powers. Portable SQL. |
